...
> SPICE и оба варианта C. Остались три внешних ворота: отдельная чистая
> Windows-машина, решение владельца о лицензировании распространения и
> короткая пользовательская приёмка. Главный договор:
